...
from routers.merchant_referrals import router as merchant_referrals_router
...
app.include_router(merchant_referrals_router, prefix="/api/merchants", tags=["Merchant Referrals"])

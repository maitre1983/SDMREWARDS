        ...
        {status === 'success' ? (
          ...
          <>
            ...
            <Button
              ...
              disabled={isProcessing || !amount || !phone || parseFloat(amount) <= 0}
            ...
            >
              {isProcessing ? <Loader2 className="animate-spin mr-2" size={18} /> : <CreditCard className="mr-2" size={18} />}
              Pay with MoMo
            </Button>
          </>
        )}

    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">Toutes les transactions clients et marchands</p>
        </div>
        <Button
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-4 text-white">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs bg-white/20 px-2 py-1 rounded">Aujourd'hui</span>
            </div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-4 text-white">
            ...
            <p className="text-sm opacity-80">Commission SDM</p>
          </div>
          <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl p-4 text-white">
            ...
            <p className="text-sm opacity-80">Cashback distribué</p>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-xl p-4 flex flex-wrap gap-4 items-center">
        <div className="flex-1 min-w-[200px]">
          <div className="relative">
            ...
            <Input
              placeholder="Rechercher par ID, marchand, téléphone..."
              value={searchTerm}
      ...
      <div className="bg-white rounded-xl overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-8 text-center">
            ...
            <p className="mt-2 text-slate-500">Aucune transaction trouvée</p>
          </div>
        ) : (
